      ...
      <div className="flex flex-col min-h-full items-stretch">
        ...
        <div className="flex w-full flex-grow mt-8 justify-center">
          <div className="w-full p-4 md:w-2/3">
            ...
            />
            <Paragraph>
              In the first example, myNum&apos;s value is copied and then assigned to copyOfMyNum.
              But in the second example copyOfMyArr is a reference to myArr. Meaning that any
              changes we make to copyOfMyArr will also affect myArr:
            </Paragraph>
            <CodeBlock
              text={
            ...
            <Paragraph>
              ...
              maintaining immutability. There are a few ways to copy the data over to the new
              object. One way is using the spread operator:
            </Paragraph>
            <CodeBlock
              text={
                'const myArr = [1, 2, 3];\nconst copyOfMyArr = [...myArr];\ncopyOfMyArr[0] = 100;\n\nconsole.log(myArr, copyOfMyArr);\n//[ 1, 2, 3 ] [ 100, 2, 3 ]}'
            ...
            <Paragraph>
              ...
              shallow copy. Which means it will only copy primitive data types over to the new
              array. If there was an array or an object inside myArr then a reference to the
              original would be created. Not a copy. Let&apos;s go over an example with an object,
              as I think that&apos;s easier to reason with:
            </Paragraph>
            <CodeBlock
              text={
            ...
            />
            <Paragraph>
              As you can see the favoriteDrinks in the copied object is just a reference to the
              array in the original. Now tying this back to React, we&apos;d be modifying state if
              we were to make any changes to the favoriteDrinks array in the copied object:
            </Paragraph>
            <CodeBlock
              text={
